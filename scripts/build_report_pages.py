...
def knowledge_graph_embed(case_title):
    graph_title = html.escape(f"{case_title} 专利证据双链图", quote=True)
    graph_url = "knowledge-graph.html?view=technology&amp;depth=2"
    return f'''<section class="graph-embed" aria-labelledby="embedded-graph-title"><div class="graph-embed__head"><div><h2 id="embedded-graph-title">交互式专利证据双链图</h2><p>在报告内直接拖拽节点、滚轮缩放并沿 family / claim / finding / source 回溯证据。</p></div><a href="knowledge-graph.html?view=technology&amp;depth=2" target="_blank" rel="noopener noreferrer">全屏查看 ↗</a></div><iframe src="{graph_url}" title="{graph_title}" loading="eager" allow="fullscreen" allowfullscreen></iframe></section>'''
