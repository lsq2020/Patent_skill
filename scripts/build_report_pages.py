...
def build_pages(project):
    ...
    index_body = '<h2>模块化交付</h2><p>每个模块均有独立页面、Markdown 正文和对应统计图；风险/FTO、技术路线、创新空间和证据链保留各自的研究边界。</p><div class="index-grid">' + "".join(cards) + '</div><h2>交互式入口</h2><div class="index-grid"><a class="index-card" href="knowledge-graph.html"><b>专利证据双链图</b><span>从 family / claim 回溯 finding 与来源，查看出链和反向链接</span></a><a class="index-card" href="report-visuals.html"><b>统计总览</b><span>查看族主题、优先权、法域、claim 类别和证据分布</span></a></div>'
