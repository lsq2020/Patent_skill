...
def knowledge_graph_embed(case_title):
    ...
    graph_url = "knowledge-graph.html?embed=report&amp;view=technology&amp;depth=2"
    return f'''<section class="graph-embed" aria-labelledby="embedded-graph-title"><div class="graph-embed__head"><div class="graph-embed__title"><h2 id="embedded-graph-title">证据双链图</h2><p class="graph-embed__hint">拖拽节点 · 滚轮缩放 · 点击查看证据</p></div><a href="knowledge-graph.html?view=technology&amp;depth=2" target="_blank" rel="noopener noreferrer">全屏 ↗</a></div><iframe src="{graph_url}" title="{graph_title}" loading="eager" allow="fullscreen" allowfullscreen></iframe></section>'''
